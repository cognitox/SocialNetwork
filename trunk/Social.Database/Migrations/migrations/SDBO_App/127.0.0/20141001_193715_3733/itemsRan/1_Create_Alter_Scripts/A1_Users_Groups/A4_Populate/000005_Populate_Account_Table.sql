...
INSERT INTO [dbo].[Account] ([AccountID],[AccountTypeID],[PaymentPlanAccountID], [Email]) VALUES (cast(cast(0 as binary) as uniqueidentifier),@Type, @PaymentPlanID, 'master@relsocial.com')
