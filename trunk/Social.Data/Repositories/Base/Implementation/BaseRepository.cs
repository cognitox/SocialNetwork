...
{
    public class BaseRepository<TEntity, TDbContext> : Social.Data.Repositories.Base.IBaseRepository<TEntity, TDbContext>
        where TDbContext : DbContext
        where TEntity : class
    {
        protected TDbContext _context;
        public DbSet<TEntity> _entitycontext;
        public IRepoUtilities<TEntity> _repositoryUtilities;
        ...
        /// <summary>
        /// Allows for searchability within the model, using 
        /// Func<TEntity, bool> predicate)
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<TEntity> Where(Func<TEntity, bool> predicate)
        {
            DbSet<TEntity> entityContext = _entitycontext;
            var results = entityContext.Where(predicate).ToList();
            return results;
        }

        /// <summary>
        /// Allows for searchability within the model, using 
        /// Func<TEntity, int, bool> predicate
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns></returns>
        public List<TEntity> Where(Func<TEntity, int, bool> predicate)
        {
            DbSet<TEntity> entityContext = _entitycontext;
            var results = entityContext.Where(predicate).ToList();
            return results;
        ...
        /// <summary>
        /// Checks if the model exists by guid
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public Boolean IsSystemAccount(TEntity model)
        {
            var retVal = true;
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public Boolean IsModelSystemType(TEntity model)
        {
            var retVal = true;
            var pkValue = _repositoryUtilities.GetPKValue(model);
