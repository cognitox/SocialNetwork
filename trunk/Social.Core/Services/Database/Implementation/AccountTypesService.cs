...
namespace Social.Core.Services.Database.Implementation
{
    ...
    public class AccountTypesService : BaseService<AccountType>, Social.Core.Services.Database.IAccountTypesService
    {
        public AccountTypesService(IUnitOfWork unitOfWork)
        {
