...
namespace Social.Core.Services.Database.Implementation
{
    ...
    public class AccountRolesService : BaseService<AccountRole>, Social.Core.Services.Database.IAccountRolesService
    {
        public AccountRolesService(IUnitOfWork unitOfWork)
        {
